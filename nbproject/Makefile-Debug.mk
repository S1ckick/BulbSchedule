...
${OBJECTDIR}/src/algos.o: src/algos.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -Ithird-party -Isrc/algos -I../or-tools/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/algos.o src/algos.cpp

${OBJECTDIR}/src/bysolver.o: src/bysolver.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -Ithird-party -Isrc/algos -I../or-tools/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/bysolver.o src/bysolver.cpp

${OBJECTDIR}/src/greedy.o: src/greedy.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -Ithird-party -Isrc/algos -I../or-tools/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/greedy.o src/greedy.cpp

${OBJECTDIR}/src/main.o: src/main.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -Ithird-party -Isrc/algos -I../or-tools/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/main.o src/main.cpp

${OBJECTDIR}/src/parser.o: src/parser.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -Ithird-party -Isrc/algos -I../or-tools/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/parser.o src/parser.cpp

${OBJECTDIR}/src/validation.o: src/validation.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -Ithird-party -Isrc/algos -I../or-tools/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/validation.o src/validation.cpp

${OBJECTDIR}/src/writer.o: src/writer.cpp
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -g -Isrc -Ithird-party -Isrc/algos -I../or-tools/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/writer.o src/writer.cpp
